...
public final class AudioDevice {
  ...
  public init(
    ...
    let ret = SDL_OpenAudioDevice(device, isCapture ? 1 : 0, &desiredSpec, &obtainedSpec, flags.rawValue)
    try throwIfFail(Int32(ret), predicate: { $0 == 0 })
    self.deviceId = ret
  ...
  public static func deviceName(at index: Int, isCapture: Bool) -> String? {
  ...
  public static func driverName(at index: Int) -> String? {
